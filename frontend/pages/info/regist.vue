	...
	<view class="regist-content">
		<view class="regist-head">
			<view class="regist-head-front">
				<u--text :bold="true" size=35 text="用户注册"></u--text>
			</view>
		</view>
		...
		<view class="regist-bottom">
			<u-button type="primary" @click="regist" text="确定"></u-button>
		</view>
	</view>
	<view class="remaining-body"></view>
	</view>
</template>
	...
	methods: {
		...
		regist(){
			...
			this.$refs.uForm.validate().then(res => {
					uni.request({
						url: self.loginServerUrl + '/system/regist',
						data: self.userInfo,
						method: 'POST',
						success(res) {
							console.log("创建成功")
